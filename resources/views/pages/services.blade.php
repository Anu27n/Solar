...
<main class="bg-auroraWhite">
    ...
    <section class="relative py-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 text-center reveal-up">
            <div class="inline-flex items-center gap-3 px-4 py-1.5 bg-solarGreen/10 rounded-full mb-10">
                <span class="text-[10px] uppercase font-black tracking-[0.3em] text-solarGreen">Energy as a Service</span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @foreach([
                    ...
                    <div class="relative p-10 bg-auroraWhite rounded-[2.5rem] border border-deepForest/5 group hover:border-solarGreen/30 transition-all duration-500 shadow-sm hover:shadow-2xl overflow-hidden min-h-[350px] flex flex-col">
                        ...
                        <div class="relative z-10">
                            <div class="text-[8px] font-black text-solarGreen/40 uppercase tracking-[0.4em] mb-8">{{ $s['s'] }}</div>
                            <h3 class="text-xl font-bold text-deepForest uppercase tracking-tighter mb-4">{{ $s['t'] }}</h3>
                            <p class="text-sm text-deepForest/60 font-medium leading-relaxed">{{ $s['d'] }}</p>
                        </div>
                        
                        <div class="mt-auto pt-12 flex justify-end relative z-10">
                            <div class="w-12 h-12 rounded-full border border-deepForest/10 flex items-center justify-center group-hover:bg-solarGreen group-hover:border-solarGreen transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="group-hover:text-deepForest transition-colors"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <section class="py-32 bg-auroraWhite border-t border-deepForest/5">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-32 items-center">
            <div class="relative">
                <div class="aspect-square rounded-[4rem] overflow-hidden shadow-2xl relative">
            ...
            <div class="space-y-12">
                <h2 class="text-4xl md:text-5xl font-bold text-deepForest tracking-tighter leading-tight uppercase">THE LAB <br/> <span class="italic text-solarGreen">PROCESS.</span></h2>
                
                <div class="space-y-10">
                    <div class="flex gap-8 group">
                        <div class="shrink-0 w-12 h-12 rounded-2xl bg-white border border-deepForest/5 flex items-center justify-center font-bold text-solarGreen text-lg shadow-md">01</div>
                        <div>
                            <h4 class="text-lg font-bold text-deepForest uppercase tracking-widest mb-1">Technical Audit</h4>
                            <p class="text-sm text-deepForest/60 font-medium leading-relaxed">Shadow analysis, load calculation, and structural integrity verification.</p>
                        </div>
                    </div>
                    <div class="flex gap-8 group">
                        <div class="shrink-0 w-12 h-12 rounded-2xl bg-white border border-deepForest/5 flex items-center justify-center font-bold text-solarGreen text-lg shadow-md">02</div>
                        <div>
                            <h4 class="text-lg font-bold text-deepForest uppercase tracking-widest mb-1">Systems Design</h4>
                            <p class="text-sm text-deepForest/60 font-medium leading-relaxed">Selecting the optimal inverter-battery-panel combination for your specific geography.</p>
                        </div>
                    </div>
                    <div class="flex gap-8 group">
                        <div class="shrink-0 w-12 h-12 rounded-2xl bg-white border border-deepForest/5 flex items-center justify-center font-bold text-solarGreen text-lg shadow-md">03</div>
                        <div>
                            <h4 class="text-lg font-bold text-deepForest uppercase tracking-widest mb-1">Deployment</h4>
                            <p class="text-sm text-deepForest/60 font-medium leading-relaxed">Certified engineering teams ensure your system is bonded and grounded to MNRE specs.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-32 bg-deepForest text-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-24">
                <h3 class="text-4xl md:text-5xl font-bold font-heading tracking-tighter mb-4 uppercase">LATEST <span class="text-solarGreen italic">IMPACT.</span></h3>
                <p class="text-white/40 uppercase tracking-[0.4em] text-[10px] font-black">Transforming the energy landscape of Uttar Pradesh.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-10">
                @foreach([
                    ...
                    <div class="group relative aspect-[3/4] rounded-[3rem] overflow-hidden border border-white/5">
                        ...
                        <div class="absolute bottom-10 left-10 space-y-2">
                            <div class="text-[10px] font-black text-solarGreen uppercase tracking-[0.4em]">{{ $p['l'] }}</div>
                            <h4 class="text-3xl font-black tracking-tighter">{{ $p['n'] }}</h4>
